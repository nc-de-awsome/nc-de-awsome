...
def generate_fact_sales_order(sales_order_df):
    ...
    sales_order_df['agreed_delivery_date'] = pd.to_datetime(sales_order_df['agreed_delivery_date'], format='%Y-%m-%d %H:%M:%S.%f', errors='coerce').dt.date
    sales_order_df['agreed_payment_date'] = pd.to_datetime(sales_order_df['agreed_payment_date'], format='%Y-%m-%d %H:%M:%S.%f', errors='coerce').dt.date
