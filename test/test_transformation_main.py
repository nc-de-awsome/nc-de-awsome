...
from deploy_processed_lambda.src.main import *
import pandas as pd
        ...
        [
            {
                ...
                "currency_id" :2,
                "agreed_delivery_date" : pd.Timestamp('2022-11-09 00:00:00.187000').to_pydatetime().date(),
                "agreed_payment_date" :pd.Timestamp('2022-11-07 00:00:00.187000').to_pydatetime().date(),
