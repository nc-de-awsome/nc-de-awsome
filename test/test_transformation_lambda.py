        ...
        [
            {
                ...
                "purchase_order_id" : 1,
                "created_date" : pd.Timestamp('2022-11-03 14:20:52.000000').to_pydatetime().date(),
                "created_time" : pd.Timestamp('2022-11-03 14:20:52.000000').to_pydatetime().time(),
                "last_updated_date" : pd.Timestamp('2022-11-03 14:20:52.000000').to_pydatetime().date(),
                "last_updated_time" : pd.Timestamp('2022-11-03 14:20:52.000000').to_pydatetime().time(),
                "staff_id" : 12,
                "counterparty_id" : 11,
                "item_code" : "ZDOI5EA",
                "item_quantity" : 371,
                ...
                "currency_id" :2,
                "agreed_delivery_date" : pd.Timestamp('2022-11-09 00:00:00.000000').to_pydatetime().date(),
                "agreed_payment_date" :pd.Timestamp('2022-11-07 00:00:00.000000').to_pydatetime().date(),
